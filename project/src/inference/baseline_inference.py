...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--checkpoint",
        default="results/baseline/outputs/checkpoints/transformer_pointcloud_net.pt",
        help="Baseline checkpoint path relative to project/ or absolute.",
    )
    parser.add_argument("--output-dir", default="results/baseline/outputs/inference")
...
def main() -> None:
    ...
    points, checkpoint = predict_pointcloud(image_path, checkpoint_path)
