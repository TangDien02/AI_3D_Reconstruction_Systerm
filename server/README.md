...
TripoSR code duoc import tu repo chinh thuc `VAST-AI-Research/TripoSR`. Clone repo do vao `project/external/TripoSR` hoac cau hinh bien moi truong `TRIPOSR_REPO_DIR`.

```powershell
cd ..
git clone https://github.com/VAST-AI-Research/TripoSR.git project/external/TripoSR
cd server
